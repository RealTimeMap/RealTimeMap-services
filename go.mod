module github.com/RealTimeMap/RealTimeMap-backend
...
require (
	...
	github.com/zishang520/socket.io/adapters/adapter/v3 v3.0.4 // indirect
	github.com/zishang520/socket.io/adapters/redis/v3 v3.0.4 // indirect
